                            ...
                            <form action="/admin" method="GET">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group-custom">
                                        ...
                                        <input type="email" class="form-control-transparent" placeholder="nama@email.com" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-5">
                                    ...
                                    <div class="input-group-custom">
                                        ...
                                        <input type="password" id="inputPassword" class="form-control-transparent" placeholder="••••••••" required>
